...
@itemlist[@item{Every @tech{Terminus} should have a @litchar{robots.txt} file placed in the proper directory.}]
...
@itemlist[@item{@italic{robots} should be told that do not index @italic{Racket Documentation}.}]
...
@itemlist[@item{All non-/-suffixed directories should be redirected to their /-suffixed counterparts.}]
...
@itemlist[@item{Paths reference to any @litchar{*.rkt} should be redirected to their @litchar{*.html} counterparts.}]

@tech{Terminus} like @tech{Per-Digimon Terminus} serves static contents that usually be auto-generated by @bold{Scribble}.
